...
namespace FinancialPortal.Controllers
{
    public class TransactionsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,BankAccountId,TransactionTypeId,BudgetItemId,OwnerId,Description,Amount,Memo,Created,Updated")] Transaction transaction)
        {
            if (ModelState.IsValid)
            {
